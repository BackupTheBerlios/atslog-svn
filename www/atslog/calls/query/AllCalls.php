...
// ------------------------------------------------------------------------------------------------------
		...
		while (!$res->EOF) {
			...
			if(empty($export)){                            
			    ...
			    echo"<td>${FontColor}$coLine${FontColorEnd} $coLineDescription</td>";
			    echo"<td>${FontColor}$intPhone${FontColorEnd} $intPhoneDescription</td>";
			    echo"<td>
				    <table width=100%>
					<tr>
...
// ------------------------------------------------------------------------------------------------------
	if(empty($export)){
	    echo("<tr ".$COLORS['AltogetherTrBgcolor'].">");
	    echo("<td>".$GUI_LANG['Total'].": <b>".$InAll[0]."</b></td>");
    	    echo("<td colspan=4>");
