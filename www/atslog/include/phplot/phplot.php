...
//Labels
    ...
    var $x_time_format = 'H:m:s';        // See http://www.php.net/manual/html/function.gmdate.html
...
//////////////////////////////////////////////////////////
    ...
    { 
        ...
        case 'plotx':
            ...
            case 'time':
		if($which_lab!=''){
            	    $lab = gmdate($this->x_time_format, $which_lab);
		}else{
		    $lab='';
		}
                break;
        ...
        case 'ploty':
            ...
            case 'time':
		if($which_lab!=''){
            	    $lab = gmdate($this->y_time_format, $which_lab);
		}else{
		    $lab='';
		}
                break;
