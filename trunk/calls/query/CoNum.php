<?
		...
		if($co != "")		$additionalReq.=" AND (calls.${CI}='".$co."')";
...
//
				...
				if(empty($export)){
				    ...
				    echo"<td><a href=\"".complitLink($local_type="CoNumDetail", $local_num=$row[0])."\" title=\"".$GUI_LANG['Number'].": $numberName, ".$GUI_LANG['ThroughAnExternalLine'].": $NamedLine\">$row[1]</a></td>";
