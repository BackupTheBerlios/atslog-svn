...
// ------------------------------------------------------------------------------------------------------
			...
			$expor_excel->MontaConteudo(0, 3,$GUI_LANG['Number']);
			$expor_excel->MontaConteudo(0, 4,$GUI_LANG['Duration']);
		...
		while (!$res->EOF) {
			...
			if(empty($export)){                            
			    ...
			    echo"<td nowrap>${FontColor}$row[0]${FontColorEng}</td>";
			    echo"<td>${FontColor}$row[6]${FontColorEng} $NamedLine</td>";
			    echo"<td>${FontColor}$row[7]${FontColorEng} $telephone</td>";
			    echo"<td>${FontColor}$row[1]${FontColorEng}</td>";
			    echo"<TD>${FontColor}".sumTotal($row[2],0)."${FontColorEng}</TD>";
			    echo "</TR>\n";
			}else{
			    ...
			    $expor_excel->MontaConteudo($linha+2, 3, $row[1]);
			    $expor_excel->MontaConteudo($linha+2, 4, sumTotal($row[2],0));
			}
